...
notable_npcs:
  - name: Garrik "Salttooth" Vane
    role: owner
    note: Claims to have cooked for three pirate kings; one-eyed; hook hand.
  - name: Krixie
    role: server
    note: Halfling with sticky fingers and a sharp memory.
  - name: Branwell
    role: regular
    note: Off-duty dockhand who’s always there, always watching.
...
# If your linker requires IDs, populate these:
connected_location_ids:
  # - bb:location:miremarket
  # - bb:location:crooked-lantern
  # - bb:location:whisperers-hollow
